...
const divStyle = {
  background:'rgba(206, 206, 65, 0.973)'
};
    ...
    return (
      ...
      <div>
        ...
        <div style={st1}>
         ...
         <button style={divStyle} onClick={() => this.clear()}> C </button>
         <button onClick={() => this.fn0()}> 0 </button>
         <button style={divStyle1} onClick={() => this.equal()}> = </button>

         </div>

         <div style={st2}>
         <button style={divStyle1} onClick={() => this.add()}> + </button>
         <button style={divStyle1} onClick={() => this.mul()}> X </button>
         <button style={divStyle1} onClick={() => this.sub()}> - </button>
         <button style={divStyle1} onClick={() => this.divi()}> / </button>
         </div>
